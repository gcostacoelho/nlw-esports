  ...
  return (
    <div className='max-w-[1344px] mx-auto flex flex-col items-center my-20'>
      ...
      <div className="grid grid-cols-6 gap-6 mt-16">
        <a href="http://" target="_blank" className='relative rounded-lg overflow-hidden'>
      ...
      <div className='pt-1 bg-nlw-gradient self-stretch mt-8 rounded-lg overflow-hidden'>
        <div className='bg-[#2A2634] px-8 py-6 flex justify-between align-center'>
          <div>
            <strong className='text-2xr text-white font-black block'>Não encontrou seu duo?</strong>
